    ...
    <div className="w-full flex flex-col items-center">
      <div className="drop-shadow-md m-8 relative bg-white w-10/12 flex-col p-8 flex md:flex-row">
        ...
        <span className="absolute w-[5%] items-center p-4 top-0 bottom-0 right-0 flex flex-col gap-2">
          <button onClick={()=>dispatch({type:"ADD_PRODUCT", payload:props.product})} className='w-[3em] transition-all hover:w-[400%] h-[3em] hover:flex hover:flex-row hover:items-center hover:justify-center group rounded-full bg-emerald-500 p-2 fill-white shadow-md '>
